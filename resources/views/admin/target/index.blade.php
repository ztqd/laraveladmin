...
@section('content')
    <div class="row page-title-row" style="margin:5px;">
        ...
        <div class="col-md-6 text-right">
            @if(Gate::forUser(auth('admin')->user())->check('admin.target.create'))
                <a href="/admin/target/create" class="btn btn-success btn-md">
                ...
                <div class="box-body">
                    <table id="tags-table" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th class="hidden-sm">经度</th>
                            <th class="hidden-sm">纬度</th>
                ...
                <script>
                    $(function () {
                            ...
                            columnDefs: [
                                {
                                    ...
                                    //编辑
                                    if (row_edit) {
                                        str += '<a style="margin:3px;" href="/admin/target/' + row['id'] + '/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                                    }
                        ...
                        $("table").delegate('.delBtn', 'click', function () {
                            ...
                            $('.deleteForm').attr('action', '/admin/target/' + id);
                            $("#modal-delete").modal();
                        });
