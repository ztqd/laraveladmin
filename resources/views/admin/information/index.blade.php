...
@section('content')
    <div class="row page-title-row" style="margin:5px;">
        ...
        <div class="col-md-6 text-right">
            @if(Gate::forUser(auth('admin')->user())->check('admin.information.create'))
                <a href="/admin/information/create" class="btn btn-success btn-md">
                ...
                <script>
                    $(function () {
                            ...
                            columnDefs: [
                                {
                                    ...
                                    //编辑
                                    if (row_edit) {
                                        str += '<a style="margin:3px;" href="/admin/information/' + row['id'] + '/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                                    }
                        ...
                        $("table").delegate('.delBtn', 'click', function () {
                            ...
                            $('.deleteForm').attr('action', '/admin/information/' + id);
                            $("#modal-delete").modal();
                        });
