...
@section('content')
    <div class="row page-title-row" style="margin:5px;">
        ...
        <div class="col-md-6 text-right">
            @if(Gate::forUser(auth('admin')->user())->check('admin.task.create'))
                            ...
                            columnDefs: [
                                {
                                    ...
                                    //编辑
                                    if (row_edit) {
                                        str += '<a style="margin:3px;" href="/admin/task/' + row['id'] + '/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                                    }
